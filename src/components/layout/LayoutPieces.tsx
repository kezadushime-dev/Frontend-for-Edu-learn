            ...
            <div className="flex items-center gap-4">
              {(items || []).map((item) => (
                <Link
                  key={item.label}
                  to={item.to}
                  className={item.className || 'text-gray-700 hover:text-primary transition-colors font-medium'}
                >
                  {item.label}
                </Link>
              ))}
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="#courses" className="text-gray-700 hover:text-primary transition-colors font-medium">
                Courses
              </a>
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-2">
        ...
        <div className="flex gap-4">
          <i
            ...
            className="w-4 h-4 hover:text-primary cursor-pointer transition transform hover:scale-110"
          ></i>
          <i
            data-lucide="twitter"
            className="w-4 h-4 hover:text-primary cursor-pointer transition transform hover:scale-110"
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-10">
          <div className="animate-fadeInUp">
            ...
            <p className="mb-6">
              Empowering learners worldwide with interactive digital education. Transform your skills with our comprehensive
              learning platform.
            </p>
            <div className="flex gap-4">
              <i
                data-lucide="facebook"
                className="w-5 h-5 hover:text-primary cursor-pointer transition transform hover:scale-110"
              ></i>
              <i
                data-lucide="twitter"
                className="w-5 h-5 hover:text-primary cursor-pointer transition transform hover:scale-110"
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '.6s' }}>
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                ...
                />
                <button className="bg-primary px-4 py-2 rounded-r-md hover:bg-blue-700 transition transform hover:scale-105">?</button>
              </div>
            </div>
          </div>
        </div>
